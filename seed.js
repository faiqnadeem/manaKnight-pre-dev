...
async function executeSeeds() {
	...
	await db.setting.insert({
		key: "copyright",
		type: 0,
		value: "Copyright © 2021 manaknightdigital. All rights reserved.",
	});
	await db.setting.insert({
		key: "license_key",
		type: 4,
	...
	await db.timeout.insert({
		id: 1,
		message:
			"You have an allergy to main incredients in our system. Our current system will not suit you",
		counter: 10,
	});
}
